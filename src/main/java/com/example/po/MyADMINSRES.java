...
public class MyADMINSRES {
	public String RESID;//请求ID
	public String RESTYPE;//请求类型
	public String RESUSERID;//请求用户
	public Date RESDATE;//申请日期
	public String RESSTATE;//申请状态
